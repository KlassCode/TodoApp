			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Todo Description</label> <input type="text"
						value="<c:out value='${ todo.description }'></c:out>" name="description" class="form-control"
						required="required">
				</fieldset>

				<fieldset class="form-group">
					<label>Todo Status</label> <select name="isDone" class="form-control">
				...
				<fieldset class="form-group">
					<label>Todo Target Date</label> <input type="date"
						value="<c:out value='${ todo.targetDate }'></c:out>" name="targetDate" class="form-control"
						required="required">
				</fieldset>
